...
$consumerKey = 'FJA3hm2sbKZyw4uIj96A90UCvmWDy0Mk';
$consumerSecret = ' i1BvUyuIpUPGHanq';
...
curl_setopt($curl_Tranfer2, CURLOPT_HTTPHEADER, array('Content-Type:application/json', 'Authorization:Bearer ' . $Token_URL));
